...
class DataIngestion:
    ...
    if __name__=="__main__":
        ...
        retriever = ElasticsearchRetriever(document_store=document_store, embedding_model=MODEL, gpu=GPU, emb_extraction_layer=-2, pooling_strategy="reduce_mean")

        data = DataIngestion();
                                    

        # index new docs
        data.index_new_docs(document_store, retriever)
